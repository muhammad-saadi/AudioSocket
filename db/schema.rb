...
ActiveRecord::Schema.define(version: 2021_11_25_071224) do
  ...
  create_table "albums", force: :cascade do |t|
    ...
    t.string "status", default: "submit"
    t.index ["artist_profile_id"], name: "index_albums_on_artist_profile_id"
  end
  ...
  add_foreign_key "albums", "artist_profiles"
