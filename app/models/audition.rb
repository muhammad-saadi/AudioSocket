class Audition < ApplicationRecord
  ...
  def self.genre
    %w[apella acid jazz acoustic acid_punk alternative hip_hop ambient avantgarde bass blues Cabaret Celtic_chamber Chanson Chorus christian_rap cinematic classical classic_rock club comedy country cult]
  end

  def self.source
    %w[Facebook Instagram Twitter other]
  end

  def self.status
    %w[pending accepted rejected deleted]
  end
